...
<div class="card card-body bg-light mt-5">
    ...
    <form id="formsFelysoft" action="<?php echo RUTA_URL; ?>proveedores/editar/<?php echo $datos['pkIdProveedores'] ?>" method="post">
        ...
        <input type="submit" class="btn btn-success" value="Editar Proveedor" onclick='return confirmarUpdate()'>
