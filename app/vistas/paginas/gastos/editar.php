...
<div class="card card-body bg-light mt-5">
    ...
    <form action="<?php echo RUTA_URL;?>gastos/editar/<?php echo $datos['pkIdGasto']?>" method="post" enctype="multipart/form-data">
        <div class="form-group">
            <label for="fecha">Fecha: <sup>*</sup></label>
            <input type="date-time" name="fecha" class="form-control form-control-lg" value="<?php echo $datos['fecha']?>">
        </div>
        <div class="form-group">
            <label for="monto">Monto: <sup>*</sup></label>
            <input type="number" name="marca" class="form-control form-control-lg" value="<?php echo $datos['monto']?>">
        </div>
        <div class="form-group">
            <label for="descripcion">Descripción: <sup>*</sup></label>
            <input type="number" name="descripcion" class="form-control form-control-lg" value="<?php echo $datos['descripcion']?>">
        </div>
        ...
        <div class="form-group">
            ...
            <option value="<?php echo $datos['compras']->pkIdCompra; ?>" selected><?php echo $datos['compras']->total; ?></option>
        ...
        <div class="form-group">
            ...
            <?php foreach($datos['pago'] as $pago) : ?>
