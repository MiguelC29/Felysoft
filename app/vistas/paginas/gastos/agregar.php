...
<div class="card card-body bg-light mt-5">
    ...
    <form action="<?php echo RUTA_URL;?>gastos/agregar" method="post" enctype="multipart/form-data">

        <div class="form-group">
            <label for="fecha">Fecha: <sup>*</sup></label>
            <input type="date-time" name="fecha" class="form-control form-control-lg" required>
        </div>
        <div class="form-group">
            <label for="monto">Monto: <sup>*</sup></label>
            <input type="numer" name="monto" class="form-control form-control-lg" required>
        </div>
        <div class="form-group">
