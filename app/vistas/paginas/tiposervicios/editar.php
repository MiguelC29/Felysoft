...
<div class="card card-body bg-light mt-5">
    ...
    <form action="<?php echo RUTA_URL;?>tiposervicios/editar/<?php echo $datos['idTipoServicio']?>" method="post">
        ...
        <input type="submit" class="btn btn-success" value="Editar Servicio">
