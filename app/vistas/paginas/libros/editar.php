...
<div class="card card-body bg-light mt-5">
    ...
    <form id="formsFelysoft" action="<?php echo RUTA_URL; ?>libros/editar/<?php echo $datos['pkIdLibro'] ?>" method="post" enctype="multipart/form-data">
        ...
        <input type="submit" class="btn btn-success" value="Editar Libro" onclick='return confirmarUpdate()'>
